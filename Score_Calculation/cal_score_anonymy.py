...
Transaction_Info = pd.read_csv('../data/Transaction_Information_deanony_0410.csv')
...
score1 = dict()
score2 = dict()
fw = open("../cal_score/score_results/score_deanonymy.csv", "w")
fw.write("Tx_id,score_deanonymy,\n")
