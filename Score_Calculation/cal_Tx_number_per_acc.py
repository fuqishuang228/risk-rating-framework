...
beta1 = 1
beta2 = 1
Transaction_Info = pd.read_csv('../data/Transaction_Information0323.csv')
Account_Info = pd.read_csv('../data/Account_Information.csv')
edges= pd.read_csv('../data/Transaction_Information0323.csv',usecols=["index_from","index_to"])
edges=np.array(edges)
nodes=np.array(Account_Info['index'])
...
fw = open("./score_results/Tx_Number_Per_Acc.csv","w")
